...
const FollowUpManager: React.FC = () => {
  ...
  const fetchFollowUps = async () => {
    try {
      const response = await axios.get('https://medcare-backend-api.onrender.com/api/followups');
  ...
  const addFollowUp = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://medcare-backend-api.onrender.com/api/followups', newFollowUp);
  ...
  const updateFollowUpStatus = async (id: string, status: 'completed' | 'rescheduled') => {
    try {
      const response = await axios.put(`https://medcare-backend-api.onrender.com/api/followups/${id}`, { status });
